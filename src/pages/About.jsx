      ...
      <div className="w-full">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            <button type="button" className="w-10 h-9 border border-gray-300 hover:border-blue-600 text-sm 
             flex items-center justify-center shrink-0">SM</button>
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-4 max-w-sm">
            <input type="number" placeholder="Enter pincode" className="bg-gray-100 px-4 py-2.5 text-sm w-full 
             border-0 outline-0" />
